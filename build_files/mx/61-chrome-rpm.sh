...
# The merge lands on a base-image file (gotcha #40): rewrite it onto a fresh
# inode so the appended header and entries survive the layer commit.
rewrite_fresh_inode "$XDG_DEFAULTS"
